...
// 			die();
        ...
        if( $_GET['action'] == "Add_Setting" ) { //login user
            ...
            $ch = curl_init( $baseurl.'add_setting' );
...
// 			die();
    	...
    	if( $_GET['action'] == "delete_setting" ) { //login user
            ...
            $ch = curl_init( $baseurl.'delete_setting' );
...
// 			die();
	...
	<h2 class="title left">Setting Sections</h2>
	
	<div class="right" style="padding: 10px 0;">
        <button style="background:  #C82D32; color:  white; padding:  8px 8px; border:  0px; border-radius:  3px;" onclick="AddSetting('1');">Add Setting</button>
    </div>
	<div class="clear"></div>
	<?php 
					    ...
					    <div class="more">
                            ...
                            <div class="more-menu">
                                ...
                                <ul class="more-menu-items" tabindex="-1" role="menu" aria-labelledby="more-btn" aria-hidden="true">
                                    <li class="more-menu-item" role="presentation" onclick="editSetting('<?php echo $val['id'];?>');">
                                        <button type="button" class="more-menu-btn" role="menuitem">Edit</button>
                                    </li>
                                    <a href="dashboard.php?p=setting&action=delete_setting&id=<?php echo $val['id'];?>" style="color: red;text-decoration: none;">
	...
	<script>
		...
		{	
		    ...
		    xmlhttp.open("GET","ajex-events.php?action=editSetting&id="+id);
		    xmlhttp.send();
		}
	    ...
	    function AddSetting()
	    {
		    ...
		    xmlhttp.open("GET","ajex-events.php?action=AddSetting");
		    xmlhttp.send();
	    }
